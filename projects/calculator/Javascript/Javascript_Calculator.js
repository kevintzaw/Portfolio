...
//this modifies valus each time a button is clicked
...
//this function updates the screen wih the contents of Display_Value
...
keys.addEventListener('click',(event)=> {
    //the target variable is an object that rpresents the element
    //that was clicked
    const {target} = event;
